    ...
    [] spawn {
        ...
        while {true} do {
            ...
            if (((diag_tickTime - _lastLootClean) > 120)) then {
                 _ammobox = ["USLaunchersBox","RULaunchersBox","USSpecialWeapons_EP1","USVehicleBox","SpecialWeaponsBox","GuerillaCacheBox","RUVehicleBox","USBasicAmmunitionBox","USBasicWeaponsBox"];
                _lastLootClean = diag_tickTime;
