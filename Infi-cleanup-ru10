    ...
    [] spawn {
        ...
        while {true} do {
            ...
            if (((diag_tickTime - _lastLootClean) > 120)) then {
                 _ammobox = ["USLaunchersBox","RULaunchersBox","USSpecialWeapons_EP1","USVehicleBox","SpecialWeaponsBox","GuerillaCacheBox","RUVehicleBox","USBasicAmmunitionBox","USBasicWeaponsBox","USVehicleBox_EP1","USBasicAmmunitionBox_EP1","USOrdnanceBox_EP1"];
                _lastLootClean = diag_tickTime;
                ...
                systemChat format["CLEANUP: Deleted %1 Loot Piles out of %2",_countCleaned,_countTotal];
            };
            ...
            if ((diag_tickTime - _lastZombieClean) > 180) then {
                ...
                systemChat format["CLEANUP: Deleted %1 Zombies out of %2",_countCleaned,_countTotal];
            };
            ...
            if ((diag_tickTime - _lastGroupClean) > 180) then {
                ...
                systemChat format["CLEANUP: Deleted %1 Groups out of %2",_countCleaned,_countTotal];
            };
            ...
            if ((diag_tickTime - _lastSeagullClean) > 180) then {
                ...
                systemChat format["CLEANUP: Deleted %1 Seagulls out of %2",_countCleaned,_countTotal];
